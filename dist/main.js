...
function menageForm() {
  ...
  const date  = new Date(); 
  const dateFormatted = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(date, "yyyy-MM-dd");
...
function addTodo()  {
  ...
  if (project.value) {
    ...
    for (let i = 0; i< _createProject__WEBPACK_IMPORTED_MODULE_0__.projectslist.length; i++) {
      if (_createProject__WEBPACK_IMPORTED_MODULE_0__.projectslist[i]._name === project.value) { 
        _createProject__WEBPACK_IMPORTED_MODULE_0__.projectslist[i]._list.push(newTodo);
        break;
      }
    }
...
function removeTodo(e) {
  if (e.target.className === 'delete-todo') { 
    ...
    if (selectedPage.className === 'week') {
      showTodo(lists.filter(list => list._dueDate < (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 1), "yyyy-MM-dd")))
    } else if ( selectedPage.className === 'today') {
      showTodo(lists.filter(list => list._dueDate === (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), "yyyy-MM-dd")));
    } else {
      showTodo()
    }
  }
...
function optionList() {
  ...
  for (let i = 0; i< _createProject__WEBPACK_IMPORTED_MODULE_0__.projectslist.length; i++) {
    ...
    option.value = _createProject__WEBPACK_IMPORTED_MODULE_0__.projectslist[i]._name;
    option.textContent = _createProject__WEBPACK_IMPORTED_MODULE_0__.projectslist[i]._name;

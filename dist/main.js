...
function removeTodoInProject(e) {
  if (e.target.className === 'delete-todo-project') {
    ...
    (0,_createTodo__WEBPACK_IMPORTED_MODULE_0__.saveTodo)();
  ...
  if (project.value) {
    for (let i = 0; i < _createProject__WEBPACK_IMPORTED_MODULE_0__.projectslist.length; i++) {
      if (_createProject__WEBPACK_IMPORTED_MODULE_0__.projectslist[i]._name === project.value) {
        ...
        newTodo._projectId = _createProject__WEBPACK_IMPORTED_MODULE_0__.projectslist[i]._id;
        break;
      }
    }
...
function removeTodo(e) {
  if (e.target.className === 'delete-todo') {
    ...
    if (todoToRemove[0]._projectId) {
      for (let i = 0; i < _createProject__WEBPACK_IMPORTED_MODULE_0__.projectslist.length; i++) {
        _createProject__WEBPACK_IMPORTED_MODULE_0__.projectslist[i]._list = _createProject__WEBPACK_IMPORTED_MODULE_0__.projectslist[i]._list.filter(
    ...
    if (selectedPage.className === 'week') {
      showTodo(
          lists.filter(
              (list) =>
                list._dueDate < (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 1), 'yyyy-MM-dd'),
          ),
      );
    } else if (selectedPage.className === 'today') {
      showTodo(
          lists.filter(
              (list) => list._dueDate === (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 'yyyy-MM-dd'),
          ),
      );
    } else {
      showTodo();
...
today.addEventListener('click', () => {
  setPage(today);
  showTodo(
    lists.filter((list) => list._dueDate === (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 'yyyy-MM-dd')),
  );
});
